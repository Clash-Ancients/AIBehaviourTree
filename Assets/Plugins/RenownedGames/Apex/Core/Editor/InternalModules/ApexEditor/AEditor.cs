    ...
    public class AEditor : Editor
    {
        ...
        protected virtual void OnMissingScriptGUI()
        {
            GUILayout.BeginVertical();
            {
                ...
                {
                    EditorGUILayout.HelpBox("Perhaps the script responsible for this component has been deleted from the project. Restore the script or delete this component.", MessageType.Error);
        ...
        private static void OverrideUnityEditor()
        {
            if (ApexUtility.Enabled && ApexUtility.Master)
            {
                                    ...
                                    if (editorCacheField != null)
                                    {
                                        ...
                                        foreach (DictionaryEntry entry in dictionary)
                                        {
                                            ...
                                            else if (keyType == typeof(Object))
                                            {
                                                ...
                                                FieldInfo editorsMultiField = editorStorageType.GetField("customEditorsMultiEdition", BindingFlags.Public | BindingFlags.Instance);
                ...
                {
                    return keyType == typeof(MonoBehaviour)
                        || keyType == typeof(Behaviour)
                        || keyType == typeof(Component)
                        || keyType == typeof(ScriptableObject);
                }
            }
        }
        ...
        public void IsDefaultEditor(bool value)
        {
            defaultEditor = value;
        }

        public bool IsSearchableEditor()
        {
            return searchableEditor;
        }

        public void IsSearchableEditor(bool value)
        {
            searchableEditor = value;
        }
        #endregion
    }
}